...
_LAZY_ATTRS: dict[str, tuple[str, str]] = {
    ...
    # vgi_rpc.stockgate (Stockgate service registration)
    "StockgateAddress": ("vgi_rpc.stockgate", "StockgateAddress"),
    "StockgateClient": ("vgi_rpc.stockgate", "StockgateClient"),
    "StockgateDeviceCredential": ("vgi_rpc.stockgate", "StockgateDeviceCredential"),
    "StockgateEndpoint": ("vgi_rpc.stockgate", "StockgateEndpoint"),
    "StockgateError": ("vgi_rpc.stockgate", "StockgateError"),
    "StockgateHeartbeat": ("vgi_rpc.stockgate", "StockgateHeartbeat"),
    "StockgateHttpResponse": ("vgi_rpc.stockgate", "StockgateHttpResponse"),
    "StockgateHttpTransport": ("vgi_rpc.stockgate", "StockgateHttpTransport"),
    "StockgateIdentity": ("vgi_rpc.stockgate", "StockgateIdentity"),
    "StockgateRegistrationGrant": ("vgi_rpc.stockgate", "StockgateRegistrationGrant"),
    "StockgateRegistrationIntent": ("vgi_rpc.stockgate", "StockgateRegistrationIntent"),
    "StockgateResolution": ("vgi_rpc.stockgate", "StockgateResolution"),
    "StockgateService": ("vgi_rpc.stockgate", "StockgateService"),
    "load_or_create_iroh_secret_key": ("vgi_rpc.stockgate", "load_or_create_iroh_secret_key"),
    "load_or_create_stockgate_identity": ("vgi_rpc.stockgate", "load_or_create_stockgate_identity"),
    "stockgate_identity": ("vgi_rpc.stockgate", "stockgate_identity"),
    ...
    "tailscale_localapi_provider": ("vgi_rpc.http", "tailscale_localapi_provider"),
    "tailscale_serve_header_provider": ("vgi_rpc.http", "tailscale_serve_header_provider"),
    "IROH_ENDPOINT_HEADER": ("vgi_rpc.http", "IROH_ENDPOINT_HEADER"),
    "iroh_forwarded_header_provider": ("vgi_rpc.http", "iroh_forwarded_header_provider"),
    "aws_alb_spiffe_provider": ("vgi_rpc.http", "aws_alb_spiffe_provider"),
    "azure_application_gateway_spiffe_provider": ("vgi_rpc.http", "azure_application_gateway_spiffe_provider"),
    "envoy_xfcc_spiffe_provider": ("vgi_rpc.http", "envoy_xfcc_spiffe_provider"),
    "gcp_load_balancer_spiffe_provider": ("vgi_rpc.http", "gcp_load_balancer_spiffe_provider"),
    "nginx_spiffe_provider": ("vgi_rpc.http", "nginx_spiffe_provider"),
    "spiffe_x509_header_provider": ("vgi_rpc.http", "spiffe_x509_header_provider"),
    "validate_spiffe_id": ("vgi_rpc.http", "validate_spiffe_id"),
